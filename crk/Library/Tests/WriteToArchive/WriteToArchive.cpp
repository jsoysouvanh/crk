...
void serializeArithmetic(crk::OutBinaryArchive<ArchiveSize, ArchiveEndianness, DataModel>& archive)
{
	...
	archive(CRK_TESTS_ARITHMETIC_DATA_CHAR8, CRK_TESTS_ARITHMETIC_DATA_CHAR16, CRK_TESTS_ARITHMETIC_DATA_CHAR32);
	archive(CRK_TESTS_ARITHMETIC_DATA_WCHAR);
	...
	archive(CRK_TESTS_ARITHMETIC_DATA_INT8, CRK_TESTS_ARITHMETIC_DATA_UINT8);
	archive(CRK_TESTS_ARITHMETIC_DATA_INT16, CRK_TESTS_ARITHMETIC_DATA_UINT16);
	archive(CRK_TESTS_ARITHMETIC_DATA_INT32, CRK_TESTS_ARITHMETIC_DATA_UINT32);
	archive(CRK_TESTS_ARITHMETIC_DATA_INT64, CRK_TESTS_ARITHMETIC_DATA_UINT64);
...
{
	crk::tests::printSystemBit();
	crk::tests::printEndianness();
	crk::tests::printArithmeticTypesSize();
